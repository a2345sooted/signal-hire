...
from ...agents.optimizer.nodes.diff_generator import diff_generator_node
...
builder.add_edge("optimizer", "diff_generator")
builder.add_edge("diff_generator", "save_optimized_resume")
