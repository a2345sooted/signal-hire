...
async def patch_candidate_note(
    ...
    # Trigger re-vectoring of the latest resume to include the new/updated note
    ...
    if current_resume:
        ...
        logger.info(f"Triggered re-vectoring for candidate {candidate_id} due to note update")
