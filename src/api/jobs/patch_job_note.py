...
from .models import JobNoteUpdate

logger = logging.getLogger(__name__)

async def patch_job_note(
    request: Request,
    job_id: uuid.UUID,
    note_id: uuid.UUID,
    body: JobNoteUpdate,
    ...
    # 3. Update the note
    success = await repo.update_job_note(note_id, body.content)
    ...
    # Trigger re-vectoring of the job to include updated note
    ...
    logger.info(f"Triggered re-vectoring for job {job_id} due to note update")
